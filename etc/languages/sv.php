...
SET_LANGUAGE_DATA([
    ...
    "403" =>                    "Hit får du inte gå!",
    "403_body_text" =>          "Denna sida är endast till för administratörer! Om du är administratör, vänligen logga in på ditt administrativa konto. Om inte, skapa några videor i stället.",
    ...
    "pfp_cached" => "Vänligen notera att det kan ta upp till 12 timmar innan din nya logotyp visas. Om du rensar sidans cacheminne uppdateras den direkt, men bara för dig själv. Andra användare kan fortfarande behöva vänta.",
    "ok" =>         "Okej",
    "ok0" =>        "Okej!",
    "ok1" =>        "Vad bra!",
    "ok2" =>        "Schysst!",
    ...
    "could_not_find" => "Videon kunde inte hittas. Kontrollera att videons ID-nummer är rättstavat och försök igen. (videons ID-nummer är $1)",
    ...
    "createAcc_email_place" =>      "sojens@example.com",
    ...
    "login_email_place" =>      "sojens@example.com",
    ...
    "comment_textfield_toolong" =>  "Texten i din kommentar kan inte innehålla mer än 1000 tecken. Måste du verkligen?",
    ...
    // reports
    "report_summary" => "Beskrivning",
    "report_summary_place" => "Skriv en kort beskrivning om vad du inte tyckte om.",
    "report_summary_required" => "Du måste fylla i en kort beskrivning om varför du lämnar rapporten. Den behöver inte vara lång, men vi behöver några detaljer så vi kan se om problemet är viktigt för oss eller inte.",
    "report_check_good" => "Se till att din rapport är hjälpsam för de som modererar sidan. Rapportera inte videor som inte bryter mot några regler.",
    
    
    "report_thanks" => "Tack för att du lämnade en rapport.",
    "report_thanks_body" => "Tack för att du lämnade en rapport. Det ser visserligen inte ut som särskilt mycket, men om du rapporterar innehåll till moderatorerna kan $sitename bli en bättre plattform."
